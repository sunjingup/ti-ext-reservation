...
use Igniter\Reservation\Models\DiningArea as DiningAreaModel;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Support\Facades\DB;

class DiningArea extends \Admin\Classes\BaseFormWidget
{
    use FormModelWidget;
    use ValidatesForm;
    ...
    public $modelClass = DiningAreaModel::class;

    public $prompt = 'lang:igniter.reservation::default.dining_areas.text_add_dining_area';

    public $formName = 'lang:igniter.reservation::default.dining_areas.text_dining_area';
    ...
    protected $defaultAlias = 'diningarea';
